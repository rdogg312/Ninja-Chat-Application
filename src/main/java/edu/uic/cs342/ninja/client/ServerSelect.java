...
import edu.uic.cs342.ninja.graphic.Display;
import edu.uic.cs342.ninja.graphic.TextField;
import edu.uic.cs342.ninja.graphic.PasswordField;
...
public class ServerSelect extends Display implements ActionListener {
	...
	public ServerSelect () {
		...
		this.logo.setIcon ( new ImageIcon (
			Thread.currentThread ().getContextClassLoader ().getResource ("images/logo.png")
		));
